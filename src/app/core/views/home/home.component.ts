...
export class HomeComponent implements OnInit {
  ...
  add(): void {
    // this.postsService.createCustomer({
    //   title: "Testing the new function",
    ...
    //   tags: ["testing", "code", "Angular"],
    //   date: new Date
    // })
    // this.postsService.deleteAll()
  }
  get(): void {
    this.postsService.getCustomersList().snapshotChanges().pipe(
      map(changes =>
        changes.map(c =>
